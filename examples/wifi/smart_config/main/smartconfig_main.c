...
void tcp_server(void *pvParam){
    ...
    tcpServerAddr.sin_port = htons( 4444 );
    int s, r;
    char recv_buf[64];
    ...
    xEventGroupWaitBits(wifi_event_group,CONNECTED_BIT,false,true,portMAX_DELAY);
        ESP_LOGI(TAG,"tcp_server task started1 \n");
...
//#if defined(MBEDTLS_PKCS1_V15)
    ...
    //unsigned char rsa_ciphertext[] = "";
    mbedtls_mpi K;

    mbedtls_mpi_init( &K );
    mbedtls_rsa_init( &rsa, MBEDTLS_RSA_PKCS_V15, 0 );

// Creating the context for RSA
    mbedtls_mpi_read_string( &K, 16, RSA_N  );
    mbedtls_rsa_import( &rsa, &K, NULL, NULL, NULL, NULL );
    mbedtls_mpi_read_string( &K, 16, RSA_P  );
    mbedtls_rsa_import( &rsa, NULL, &K, NULL, NULL, NULL );
    mbedtls_mpi_read_string( &K, 16, RSA_Q  );
    mbedtls_rsa_import( &rsa, NULL, NULL, &K, NULL, NULL );
    mbedtls_mpi_read_string( &K, 16, RSA_D  );
    mbedtls_rsa_import( &rsa, NULL, NULL, NULL, &K, NULL );
    mbedtls_mpi_read_string( &K, 16, RSA_E );
